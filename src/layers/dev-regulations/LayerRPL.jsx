...
export default function LayerRPL({ onFeatureClick, layerColor = "#000" }) {
  ...
  useEffect(() => {
    ...
    fetch("/test-data/dev-regulations/rpl_polygon.geojson")
      .then((res) => res.json())
      .then((data) => {
        setGeojsonData(data);
    ...
    fetch("/test-data/dev-regulations/rpl_point.geojson")
      .then((res) => res.json())
      .then((data) => {
        setPointsData(data);
      })
