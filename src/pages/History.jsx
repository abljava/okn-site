...
function History() {
  ...
  return (
    <>
      <main className="bg-blueGray relative pb-16 md:pb-6  z-10 px-5 2xl:text-2xl">
            ...
            <div className="md:border-l-2 md:border-white/40 md:pl-5 2xl:pl-[100px]">
              ...
              <div className="flex flex-col py-8 md:py-5 space-y-8 md:space-y-6 text-xs xl:text-xl">
                <p>
                  ...
                  напротив него. По его приказу «Америка» заходила во все бухты
                  северного побережья пролива, включая самую большую. Места эти
                  произвели на него очень сильное впечатление. Граф распорядился
                  назвать по аналогии с Константинополем (Стамбулом), ключевым
                  городом на пути из Европы в Азию и столицей Османской империи,
                  основные топонимы, а именно пролив Босфор-Восточный, и бухту
                  Золотой Рог. Северо-западную часть бухты, удобной для
                  устройства порта, он предложил назвать Порт Владивосток – ясно
                  обозначая ключевой характер этого места для удержания
                ...
                <p>
                  ...
                  морской науки, и поэтому должен быть главным по своим морским
                  учреждениям.
                </p>
                <p>
                  ...
                  артиллерийской бригады, прибывший во Владивосток под командой
                  прапорщика С.А. Гильдебранта в августе-сентябре 1862 г. и
                  размещенный на окраинах тогдашнего поста, а именно на вершинах
                  горы Тигровой и расположенной к северу от нее Батарейной
                  сопки, что уже тогда указывало на ключевое значение этих высот
                  в системе обороны Владивостока.
                </p>
              </div>
              <img
              ...
              <div className="flex flex-col py-8 space-y-10 md:py-5 md:space-y-5 text-xs xl:text-xl">
                <p>
                  ...
                  был возведен несколько позже, в 1880 г. Это вывело Владивосток
                  в ряды важнейших пунктов азиатской части России. Однако лишь в
                  1876 г. главное инженерное управление выделило 30 тыс. рублей
                  на укрепление обороны Владивостока и Николаевска-на-Амуре,
                  поскольку в преддверии Русско-турецкой войны 1877–1878 гг.
                  резко ухудшились отношения с Англией, имевшей большое влияние
                  на Китай. Основная часть выделенных средств предназначалась
                ...
                <p>
                  ...
                  мог обеспечить сколько-нибудь удовлетворительную защиту,
                  поэтому из Хабаровска во Владивосток отправили десять
                  6-дюймовых нарезных мортир и 200 морских мин, однако до конца
                  года они так и не прибыли. Такое внимание к Владивостоку не
                  было случайным, поскольку уже 12 апреля 1877 г. Российская
                  империя объявила войну Турции, началась Русско-турецкая война
